...
public class AnimationController : MonoBehaviour
{
    ...
    public float runningAnimationMultiplier = 1;
    ...
    private void Update()
    {
        ...
        if (player.highSpeed == false)
            runningAnimationMultiplier = 1;
        else
            runningAnimationMultiplier = 6f;

        animator.SetFloat("Running Multiplier", runningAnimationMultiplier);
